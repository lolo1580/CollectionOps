...
- Les futures routes d'espace et d'objet doivent utiliser le contrôle commun `require_space_permission` après chargement de l'adhésion. Les routes d'invitation utilisent `require_space_owner` avec le propriétaire courant.
