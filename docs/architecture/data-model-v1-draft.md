...
| Objet | Identifiant stable, espace courant, nom non vide, numéro d'inventaire attribué par le serveur, révision positive, état `active` / `archived` / `trashed`. | Appartient à exactement un espace courant. |
