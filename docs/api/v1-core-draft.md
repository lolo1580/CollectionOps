...
La liste des sessions et la connexion sont exposées depuis le 2026-09-22 (voir [ADR-0003](../architecture/ADR-0003-local-credentials-and-sessions.md)). Les invitations à droits sélectionnables, la gestion des membres, le renommage simple, l'archivage et la corbeille sont exposés depuis le 2026-09-23 ; l'édition enrichie, les documents, les montants et la synchronisation exigent encore leurs contrats spécifiques. Seule la création d'objet accepte à ce stade une clé de rejeu ; l'idempotence des autres commandes reste à définir avant ouverture aux modifications hors ligne.
